      ...
      <div class="card border-success shadow h-100 py-2">
        ...
        >
          ...
          <div class="dropdown no-arrow">
            <a href="#/ingredients/add" class="link text-success" data-toggle="tooltip"
              title="Tambah Bahan">
            ...
            <table class="table table-bordered table-stripped">
              ...
              <tbody>
                <tr v-for="(v, k) in data.data" :key="k">
                  ...
                  <td>{{ v.slug }} </td>
                  <td>
                    <a class="btn btn-outline-primary" :href="`#/ingredients/add?slug=${v.slug}`">Edit</a>
...
export default {
  ...
  methods: {
    ...
    deleteItem (v) {
      ...
      if (c) {
        HTTP.delete('/v1/ingredients/' + v.id).then(res => {
