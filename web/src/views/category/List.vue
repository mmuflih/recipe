      ...
      <div class="card border-success shadow h-100 py-2">
        ...
        >
          ...
          <div class="dropdown no-arrow">
            <a href="#/categories/add" class="link text-success" data-toggle="tooltip"
            ...
            <table class="table table-bordered table-stripped">
              ...
              <tbody>
                <tr v-for="(v, k) in data.data" :key="k">
                  ...
                  <td>{{ v.slug }} </td>
                  <td>
                    <a class="btn btn-outline-primary" :href="`#/categories/add?slug=${v.slug}`">Edit</a>
...
export default {
  ...
  methods: {
    ...
    deleteItem (v) {
      ...
      if (c) {
        HTTP.delete('/v1/categories/' + v.id).then(res => {
